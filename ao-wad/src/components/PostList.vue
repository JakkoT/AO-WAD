    ...
    <div v-for="post in posts" :key="post.id" class="post">
        <table>
            <tbody>
                <tr>
                    <td>
                        <img src="@/assets/icon.png" alt="User icon" width="30" height="30" />
                    </td>
                    <td>
                        <p>{{ post.createTime }}</p>
                    </td>
                ...
                <tr v-if="post.image">
                    ...
                    -->
                        <img class="postimg" :src="require(`@/assets/${post.image}`)" alt="Post image" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr>
                    <td>
                        <img :src="require(`@/assets/${post.reaction}`)" alt="Reaction" width="25" height="25" />
                    </td>
                </tr>
            </tbody>
        </table>
...
export default { // Export it to vue
